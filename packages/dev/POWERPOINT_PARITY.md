...
The core now provides `setParagraphIndent` for left/right/first-line overrides, including table cells, selective inheritance reset, and atomic range validation. It is registered in the editor command catalog. This is a prerequisite for interactive ruler handles, which remain outstanding.
