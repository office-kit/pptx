...
- Still missing here: native reorder-overlapping view, Regroup, slide-relative distribution, pane locks, and complete native geometry/styling. Full-operation parity remains incomplete.
