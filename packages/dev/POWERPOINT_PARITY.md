...
- Solid fill and outline now share the palette, retaining theme references and keeping their raw selected color separate from the resolved swatch. Locked selections disable both controls. Pattern, text, table and background color controls still use their existing pickers.
