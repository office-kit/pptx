...
- Direction UI remains outstanding: native `tileRect` is now read and written through the gradient API, with round-trip and schema tests; its preview rendering remains outstanding. The native Rectangular and Path galleries still need comparison.
