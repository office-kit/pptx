...
//
// The per-script `<a:font script="…">` lists in majorFont / minorFont are
// Office's own, verbatim. They are what a renderer consults for a script the
// run names no face for — a Thai run under this theme resolves to Cordia New
// (minor) or Angsana New (major) instead of whatever the renderer would pick
// on its own. CT_FontCollection orders them after latin / ea / cs.
