...
/** Image placement inside its fill area; percentages use fractions (0.25 = 25%). */
...
export const readImageFillLayout = (fill: XmlElement): ImageFillLayout => {
...
export const writeImageFillLayout = (fill: XmlElement, layout: ImageFillLayout): void => {
  let mode: XmlElement;
  if (layout.mode === 'tile') {
