...
- Presentation mode plays cut through black, fade (including through black), push, wipe, cover, uncover and zoom, plus split, circle, diamond, plus, blinds and comb. Split supports horizontal/vertical and inward/outward variants. Normal preview remains immediate.
...
- Other selectable effects (including dissolve, checkerboard, random bars, strips, wheel and random) still need visual playback; they currently switch immediately. Object-animation playback remains a separate requirement.
