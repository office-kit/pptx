...
export const ja: Record<string, string> = {
  ...
  'Diagonal stripes: Light upward': '斜め線（右上がり、細）',
  'Diagonal stripes: Dark downward': '斜め線（右下がり、太）',
  'Diagonal stripes: Dark upward': '斜め線（右上がり、太）',
  'Diagonal stripes: Wide downward': '斜め線（右下がり、幅広）',
  'Diagonal stripes: Wide upward': '斜め線（右上がり、幅広）',
  'Vertical stripes: light': '縦線（細）',
  'Horizontal stripes: Light': '横線（細）',
  'Vertical stripes: Narrow': '縦線（狭い）',
  'Horizontal stripes: Narrow': '横線（狭い）',
  'Vertical stripes: Dark': '縦線（太）',
  'Horizontal stripes: Dark': '横線（太）',
  'Stripes: Backslashes': '斜め破線（右下がり）',
  'Stripes: Slashes': '斜め破線（右上がり）',
  'Horizontal stripes: Alternating horizontal lines': '横破線',
  'Vertical stripes: Alternating vertical lines': '縦破線',
  'Small confetti': '紙吹雪（小）',
  'Large confetti': '紙吹雪（大）',
  'Zig zag': 'ジグザグ',
  Wave: '波',
  'Diagonal brick': '斜めれんが',
  'Horizontal brick': '横れんが',
  Weave: '織物',
  Plaid: 'タータンチェック',
  Divot: '切り込み',
  'Dotted grid': '点線格子',
  'Dotted diamond grid': '点線ひし形格子',
  Shingle: '屋根瓦',
  Trellis: '格子',
  Sphere: '球',
  'Small grid': '格子（小）',
  'Large grid': '格子（大）',
  'Small checker board': '市松模様（小）',
  'Large checker board': '市松模様（大）',
  'Outlined diamond grid': 'ひし形格子',
  'Solid diamond grid': 'ひし形',
  'Dotted: 5%': '点：5%',
  'Dotted: 10%': '点：10%',
  'Dotted: 20%': '点：20%',
  'Dotted: 25%': '点：25%',
  ...
  'From Bottom Right Corner': '右下隅から',
  'From Bottom Left Corner': '左下隅から',
  'From Center': '中央から',
  'From Top Right Corner': '右上隅から',
  'From Top Left Corner': '左上隅から',
  'Linear Down': '下方向',
  ...
  Radial: '放射状',
  Rectangular: '四角',
  'Gradient stops': 'グラデーションの分岐点',
  'Gradient stop': '分岐点',
  'Gradient angle': 'グラデーションの角度',
  'Add gradient stop': '分岐点の追加',
  'Remove gradient stop': '分岐点の削除',
  'Gradient stop color': '分岐点の色',
  'Gradient stop position': '分岐点の位置',
  'Gradient stop transparency': '分岐点の透明度',
  'Gradient stop brightness': '分岐点の明るさ',
  Type: '種類',
  Angle: '角度',
  Path: 'パス',
  Brightness: '明るさ',
  'Rotate with shape': '図形に合わせて回転する',
  'Select one shape to edit gradient stops.': '分岐点を編集する図形を1つ選択してください。',
  Color: '色',
  Transparency: '透明度',
  'Fill type': '塗りつぶしの種類',
  ...
  'Format Shape...': '図形の書式設定...',
  'Close Format Shape': '図形の書式設定を閉じる',
  'Size and Position...': 'サイズと位置...',
  'Fill & Line': '塗りつぶしと線',
  ...
  Baseline: 'ベースライン',
  Auto: '自動',
  'Line Breaks and Alignment': '改行と配置',
  'Line Breaking:': '改行:',
  'Use Asian typography rules': '日本語と英語の禁則処理を行う',
  'Allow Latin text to wrap in the middle of a word': '英単語の途中で改行する',
  'Allow hanging punctuation': '句読点のぶら下げを行う',
  'Text Alignment:': '文字の配置:',
  'Indents and Spacing': 'インデントと行間隔',
  'Line Spacing Options...': '行間のオプション...',
