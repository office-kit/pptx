// Render every slide of a .pptx with @office-kit/pptx's own previewer and rasterize it
// to pixels — no browser. The whole SVG→resvg→RGBA pipeline now lives in
// `@office-kit/pptx-preview/node`; the harness only feeds it a deck and a width.

import { getSlides, getSlideSize, type PresentationData } from '@office-kit/pptx';
